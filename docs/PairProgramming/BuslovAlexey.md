...
1. Разрабатывали систему парсинга таблицы(Excel) с применением паттерна композит
2. Понравилось:
...
2. Понравилось:
	Разработка идет в два раза быстрее, оба программиста работают над одной задачей и следят за еёё выполнением, следовательно, при наличии ошибки,
